...
namespace EjercicioArrayListDeUnaClase
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            almacenar += Persona1.ID + " ";
            almacenar += Persona1.Nombres + " ";
            almacenar += Persona1.Apellidos + " ";
            almacenar += Persona1.Correo + " ";
            almacenar += Persona1.FechaNacimiento + " ";
            almacenar += Persona1.Salario + " ";
            almacenar += Persona2.ID + " ";
            almacenar += Persona2.Nombres + " ";
            almacenar += Persona2.Apellidos + " ";
            almacenar += Persona2.Correo + " ";
            almacenar += Persona2.FechaNacimiento + " ";
            almacenar += Persona2.Salario + " ";
        }
        ...
        private void tsbNuevo_Click(object sender, EventArgs e)
        {
            ...
            almacenar += MiPersona.ID + " ";
            almacenar += MiPersona.Nombres + " ";
            almacenar += MiPersona.Apellidos + " ";
            almacenar += MiPersona.Correo + " ";
            almacenar += MiPersona.FechaNacimiento + " ";
            almacenar += MiPersona.Salario + " ";
            ...
            txtSalario.Clear();
            txtID.Focus();
            objDatos = new StreamWriter("EjercicioArrayListDeUnaClase.txt");

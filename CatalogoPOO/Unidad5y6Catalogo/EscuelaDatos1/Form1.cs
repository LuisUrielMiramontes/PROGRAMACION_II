    ...
    public partial class Form1 : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (cmbUsuario.Text == "Alumno")
            {
                ...
                almacenar += ObjAlumno.Nombre + " ";
                almacenar += ObjAlumno.FechaNac + " ";
                almacenar += ObjAlumno.Curp + " ";
                almacenar += ObjAlumno.Telefono + " ";
                almacenar += ObjAlumno.email + " ";
                almacenar += ObjAlumno.Usuario + " ";
                Alumno objAlumno = new Alumno();
                objAlumno.Show();
                objDatos = new StreamWriter("EscuelaDatos1Alumno.txt");
            ...
            if (cmbUsuario.Text == "Docente")
            {
                ...
                almacenar += ObjDocente.Nombre + " ";
                almacenar += ObjDocente.FechaNac + " ";
                almacenar += ObjDocente.Curp + " ";
                almacenar += ObjDocente.Telefono + " ";
                almacenar += ObjDocente.email + " ";
                almacenar += ObjDocente.Usuario + " ";
                Docente objDocente = new Docente();
                objDocente.Show();
                objDatos = new StreamWriter("EscuelaDatos1Docente.txt");
                objDatos.Write(almacenar);
                objDatos.Close();
                Console.ReadLine();
            }
